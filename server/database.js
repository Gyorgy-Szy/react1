...
function initializeDatabase() {
  db.serialize(() => {
    ...
    const translations = [
      ...
      { lang: 'en', namespace: 'config', key: 'newInCode', value: '(New in code)' },
      { lang: 'en', namespace: 'config', key: 'notUsedInCode', value: '(Not used in code)' },
      ...
      { lang: 'hu', namespace: 'config', key: 'newInCode', value: '(Új a kódban)' },
      { lang: 'hu', namespace: 'config', key: 'notUsedInCode', value: '(Nincs használva a kódban)' },
      ...
      { lang: 'sd', namespace: 'config', key: 'newInCode', value: '(ڪوڊ ۾ نئون)' },
      { lang: 'sd', namespace: 'config', key: 'notUsedInCode', value: '(ڪوڊ ۾ استعمال نه ٿيو)' },
